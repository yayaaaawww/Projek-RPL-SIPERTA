...
@section('content')
    ...
    <div class="card p-4" style="max-width:600px;">
        ...
        <form action="{{ route('ahli.profile.update') }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="bidang" value="{{ old('bidang', $user->bidang) }}" placeholder="mis. Agronomi, Hama Penyakit">
            </div>
            <div class="mb-3">
