        ...
        <div class="dashboard-content">
            ...
            <div class="katalog-grid" id="katalogGrid">
                ...
                <div class="produk-card">
                    ...
                    <p>Rp 6.000/Kg</p>
                    <div>
                        <button class="btn-update" onclick="beliProduk('Padi Premium', 6000, 50)"> Beli </button>
                        <button class="btn-update" onclick="tambahKeranjang('Padi Premium', 6000, 50)"> + Keranjang </button>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title">
                    Detail Produk & Riwayat Penjualan
                </h5>
...
const katalogGrid =
document.getElementById("katalogGrid");
...
formProduk.addEventListener("submit", function(e){
    ...
    <small>Stok : ${stok} Ton</small>

    <div class="mt-2">

        <button
            class="btn-update"
            onclick="beliProduk('${nama}',${harga},${stok})">
    ...
    katalogGrid.insertBefore(card, addCard);
...
function beliProduk(nama,harga,stok)
{
    localStorage.setItem("namaProduk", nama);
    localStorage.setItem("hargaProduk", harga);
    localStorage.setItem("stokProduk", stok);
